...
return {
    ...
    variants = {
        ...
        Style = {
            ...
            _nullable = false,
            options = {
                modern = "apa_v_mp_h_01_c",
                moody = "apa_v_mp_h_02_c",
                vibrant = "apa_v_mp_h_03_c",
                sharp = "apa_v_mp_h_04_c",
                monochrome = "apa_v_mp_h_05_c",
                seductive = "apa_v_mp_h_06_c",
                regal = "apa_v_mp_h_07_c",
                aqua = "apa_v_mp_h_08_c",
            },
        },
        Smoke = {
            _type = "stages",
